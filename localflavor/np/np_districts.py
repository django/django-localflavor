...
# list of districts in Zanakpur Zone
JANAKPUR_DISTRICTS = [
    (('dhanusa'), _('Dhanusa')),
    (('dholkha'), _('Dholkha')),
...
ALL_DISTRICTS = BAGMATI_DISTRICTS + BHERI_DISTRICTS + DHAWALAGIRI_DISTRICTS + GANDAKI_DISTRICTS +JANAKPUR_DISTRICTS + KARNALI_DISTRICTS + KOSHI_DISTRICTS \
...
ALL_DISTRICTS.sort(key= lambda district: district[0])
