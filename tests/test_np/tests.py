...
from localflavor.np.forms import  NPDistrictSelect , NPProvinceSelect, NPZoneSelect, PostalCodeFormField
...
class NepalDetails(SimpleTestCase):
    ...
    def test_PostalCodeFieldTest(self):
        ...
        self.assertFieldOutput(PostalCodeFormField, valid, invalid)