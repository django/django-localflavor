...
<option value="24">Zaporizhia Oblast</option>
<option value="25">Zhytomyr Oblast</option>
<option value="26">Kyiv City</option>
<option value="27">Sevastopol City</option>
</select>'''
        self.assertHTMLEqual(f.render('region', None), out)

    def test_UAPostalCodeField(self):
        error = [UAPostalCodeField.default_error_messages['invalid']]
        valid = {
            '41019': '41019',
            '03190': '03190',
            '33000': '33000',
